<x-admin.app >
    ...
    @include('dashboard.playlist.modal')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Playlist</div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table-striped table" id="datatable_playlist">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Nama Playlist</th>
    ...
    @slot('script')
        ...
        @include('Dashboard.playlist.script')
